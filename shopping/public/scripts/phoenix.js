...
(function(global, factory) {
    ...
    const docReady = e => { "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", e) : setTimeout(e, 1); };
    const resize = e => window.addEventListener("resize", e);
    const camelize = e => { const t = e.replace(/[-_\s.]+(.)?/g, ((e, t) => t ? t.toUpperCase() : "")); return `${t.substr(0,1).toLowerCase()}${t.substr(1)}` };
    const getData = (e, t) => { try { return JSON.parse(e.dataset[camelize(t)]) } catch (o) { return e.dataset[camelize(t)] } };
    ...
    const getItemFromStore = (e, t, o = localStorage) => { try { return JSON.parse(o.getItem(e)) || t } catch { return o.getItem(e) || t } };
    const getDates = (e, t, o = 864e5) => { const r = (t - e) / o; return Array.from({ length: r + 1 }, ((t, r) => new Date(e.valueOf() + o * r))) };
    ...
    const toastInit = () => {
        ...
        if (t) {
            ...
            t.addEventListener("click", (() => { e && e.show(); }));
        }
    };
    ...
    const featherIconsInit = () => { window.feather.replace({ width: "16px", height: "16px" }); };

    const { merge: merge$2 } = window._;
    const echartSetOption = (e, t, o) => { e.setOption(merge$2(o(), t)); };

    const basicEchartsInit = () => {
        document.querySelectorAll("[data-echarts]").forEach((t => {
            const o = getData(t, "echarts"),
                e = window.echarts.init(t);
            echartSetOption(e, o, (() => ({ color: getColor("primary"), tooltip: { trigger: "item", padding: [7, 10], backgroundColor: getColor("gray-100"), borderColor: getColor("gray-300"), textStyle: { color: getColor("dark") }, borderWidth: 1, transitionDuration: 0 }, xAxis: { type: "category", data: getDates(new Date("5/1/2022"), new Date("5/7/2022"), 864e5), show: !0, boundaryGap: !1, axisLine: { show: !0, lineStyle: { color: getColor("gray-200") } }, axisTick: { show: !1 }, axisLabel: { formatter: t => window.dayjs(t).format("DD MMM"), interval: 6, showMinLabel: !0, showMaxLabel: !0, color: getColor("gray-800") } }, yAxis: { show: !1, type: "value", boundaryGap: !1 }, series: [{ type: "bar", symbol: "none" }], grid: { left: 22, right: 22, top: 0, bottom: 20 } })));
        }));
    };

    const togglePaginationButtonDisable = (t, e) => { t.disabled = e, t.classList[e ? "add" : "remove"]("disabled"); },
        listInit = () => {
            if (window.List) {
                const t = document.querySelectorAll("[data-list]");
                t.length && t.forEach((t => {
                    let e = getData(t, "list");
                    e.pagination && (e = {...e, pagination: { item: "<li><button class='page' type='button'></button></li>", ...e.pagination } });
                    ...
                    o.on("updated", (function(i) {
                        const n = t.querySelector(".fallback") || document.getElementById(e.fallback);
                        n && (0 === i.matchingItems.length ? n.classList.remove("d-none") : n.classList.add("d-none"));
                    }));
                    ...
                    let d = Math.ceil(c / g),
                        ...
                        p = 1;
                    r && r.addEventListener("search.close", (() => { o.fuzzySearch(""); }));
                    const b = () => { l && (l.innerHTML = `${o.i} to ${u} <span class='text-600'> Items of </span>${c}`), n && togglePaginationButtonDisable(n, 1 === p), i && togglePaginationButtonDisable(i, p === d), p > 1 && p < d && (togglePaginationButtonDisable(i, !1), togglePaginationButtonDisable(n, !1)); };
                    b(), i && i.addEventListener("click", (t => {
                        t.preventDefault(), p += 1;
                        const e = o.i + g;
                        e <= o.size() && o.show(e, g), u += o.visibleItems.length, b();
                    })), n && n.addEventListener("click", (t => {
                        t.preventDefault(), p -= 1, u -= o.visibleItems.length;
                        const e = o.i - g;
                        e > 0 && o.show(e, g), b();
                    }));
                    const h = () => { s.classList.toggle("d-none"), a.classList.toggle("d-none"); };
                    a && a.addEventListener("click", (() => { o.show(1, c), d = 1, p = 1, u = c, b(), h(); })), s && s.addEventListener("click", (() => { o.show(1, g), d = Math.ceil(c / g), p = 1, u = o.visibleItems.length, b(), h(); })), e.pagination && t.querySelector(".pagination").addEventListener("click", (t => { "page" === t.target.classList[0] && (p = Number(t.target.innerText), b()); }));
                }));
            }
        };
    ...
    const fromValidationInit = () => { document.querySelectorAll(".needs-validation").forEach((t => { t.addEventListener("submit", (a => { a.preventDefault(), a.stopPropagation(), t.classList.add("was-validated"); }), !1); })); };
    ...
    const docComponentInit = () => {
        ...
        e.forEach((e => {
            ...
            d ? e.addEventListener("click", (() => { l.toggle(); })) :
    ...
    const swiperInit = () => {
        ...
        e && e.forEach((e => {
            ...
            if (i) {
                ...
                if (s.setAttribute("class", "swiper-container thumb"), s.innerHTML = `<div class='swiper-wrapper'>${r}</div>`, i.parent) { document.querySelector(i.parent).parentNode.appendChild(s); } else t.parentNode.appendChild(s);
                n = new window.Swiper(s, i);
            }
            const s = e.querySelector(".swiper-nav");
            new window.Swiper(t, {...r, navigation: { nextEl: s ? e.querySelector(".swiper-button-next").prevEl : s ? e.querySelector(".swiper-button-prev") }, thumbs: { swiper: n } });
        }));
    };
        ...
        productDetailsInit = () => {
            ...
            if (e) {
                const t = e.querySelector("[data-product-color]"),
                    i = (e.querySelector("[data-product-quantity]"), e.querySelector('[data-quantity] input[type="number"]')),
                    ...
                    a = t => {
                        ...
                        const o = new window.Swiper(n, { slidesPerView: 5, spaceBetween: 16, direction: getThubmnailDirection(), breakpoints: { 768: { spaceBetween: 100 }, 992: { spaceBetween: 16 } } }),
                            d = i.querySelector(".swiper-nav");
                        resize((() => { o.changeDirection(getThubmnailDirection()); })), new Swiper(i, {...r, navigation: { nextEl: d ? e.querySelector(".swiper-button-next"), prevEl: d ? e.querySelector(".swiper-button-prev") }, thumbs: { swiper: o } });
                    },
                    n = r.querySelectorAll("[data-variant]");
                n.forEach((e => {
                    e.classList.contains("active") && (a(getData(e, "products-images")), t.innerHTML = getData(e, "variant"));
                    const i = getData(e, "products-images");
                    e.addEventListener("click", (() => { a(i), n.forEach((e => { e.classList.remove("active"); })), e.classList.add("active"), t.innerHTML = getData(e, "variant"); }));
                })), i.addEventListener("change", (e => { "" == e.target.value && (e.target.value = 0); }));
            }
        };

    const ratingInit = () => { document.querySelectorAll("[data-rater]").forEach((t => { const e = { reverse: getItemFromStore("isRTL"), starSize: 32, step: .5, element: t, rateCallback(t, e) { this.setRating(t), e(); }, ...getData(t, "rater") }; return window.raterJs(e) })); };
                ...
                u = merge$1({
                    ...
                    init: function() {
                        ...
                        m.length && m.forEach((e => {
                            ...
                            r.options.addedfile.call(r, o), r.options.thumbnail.call(r, o, `${e.url}/${e.name}`);
                        })), r.on(s, (function() { "maxFiles" in d && (1 === d.maxFiles && e.querySelectorAll(o).length > 1 && e.querySelector(o).remove(), 1 === d.maxFiles && this.files.length > 1 && this.removeFile(this.files[0])); }));
                    },
                    error(e, r) { if (e.previewElement) { e.previewElement.classList.add("dz-error"), "string" != typeof r && r.error && (r = r.error); for (let o of e.previewElement.querySelectorAll("[data-dz-errormessage]")) o.textContent = r; } }
                }, d);
            e.querySelector(r).innerHTML = "";
            const p = new window.Dropzone(e, u);
            p.on(s, (() => { e.querySelector(o) && e.querySelector(o).classList.remove(i), e.classList.add(t); })), p.on(a, (() => { e.querySelector(o) && e.querySelector(o).classList.remove(l), e.classList.add(i); })), p.on(c, (() => { e.querySelector(o) && e.querySelector(o).classList.remove(l), e.classList.add(i); }));
        }));
    };

    const choicesInit = () => {
        const t = document.querySelectorAll("[data-choices]");
        t.length && t.forEach((t => { const e = getData(t, "options"); return new Choices(t, { itemSelectText: "", ...e }) }));
    };

    const { merge: merge } = window._, tinymceInit = () => {
        const e = document.querySelectorAll("[data-tinymce]");
        window.tinymce && e.forEach((e => {
            const t = getData(e, "tinymce"),
                n = merge({ selector: ".tinymce", height: "50vh", skin: "oxide", menubar: !1, content_style: `\n        .mce-content-body { \n          color: ${getColor("black")} \n        }\n        .mce-content-body[data-mce-placeholder]:not(.mce-visualblocks)::before {\n          color: ${getColor("gray-400")};\n          font-weight: 400;\n          font-size: 12.8px;\n        }\n        `, mobile: { theme: "mobile", toolbar: ["undo", "bold"] }, statusbar: !1, plugins: "link,image,lists,table,media", theme_advanced_toolbar_align: "center", toolbar: [{ name: "history", items: ["undo", "redo"] }, { name: "formatting", items: ["bold", "italic", "underline", "strikethrough"] }, { name: "alignment", items: ["alignleft", "aligncenter", "alignright", "alignjustify"] }, { name: "list", items: ["numlist", "numlist"] }, { name: "link", items: ["link"] }] }, t);
    ...
    const responsiveNavItemsInit = () => {
        const e = "[data-nav-item]",
            ...
            s = () => {
                ...
                let d = 0;
                o.style.display = "none", a.forEach((e => {
                    const t = e.clientWidth;
                    if (d += t, d + c + s > n && !e.classList.contains("dropdown")) {
                        o.style.display = "block", e.style.display = "none";
                        const t = e.firstChild.cloneNode(!0);
                        r.querySelector(".category-list").appendChild(t);
                    }
                }));
                r.querySelectorAll(".dropdown-menu .nav-link").forEach((e => { e.classList.remove("nav-link"), e.classList.add("dropdown-item"); }));
            };
        if (r) {
            window.addEventListener("load", (() => { s(); })), resize((() => {
                const t = r.querySelectorAll(e),
                    l = r.querySelectorAll(o);
                t.forEach((e => e.removeAttribute("style"))), l.forEach((e => e.innerHTML = "")), s();
            }));
    ...
    const zeroRoadmapChartInit = () => {
        ...
        if (t) {
            ...
            var e = {
                levels: [{ name: "month", scales: [{ unit: "month", format: "%F, %Y" }, { unit: "week", format: "Week #%W" }] }, { name: "year", scales: [{ unit: "year", step: 1, format: "%Y" }] }, {
                    name: "week",
                    scales: [{
                        unit: "week",
                        step: 1,
                        format: function(t) {
                            ...
                            return "#" + gantt.date.date_to_str("%W")(t) + ", " + e(t) + " - " + e(a)
                        }
                    }, { unit: "day", step: 1, format: "%j %D" }]
                }]
            };
            gantt.ext.zoom.init(e), gantt.ext.zoom.setLevel("week"), gantt.ext.zoom.attachEvent("onAfterZoom", (function(t, e) { document.querySelector("input[value='" + e.name + "']").checked = !0; })), gantt.config.columns = [{ name: "text", width: 56, resize: !0 }], gantt.templates.task_class = (t, e, a) => a.task_class, gantt.templates.task_cell_class = function(t, e) { return "weekend" }, gantt.templates.task_text = () => "", window.gantt.init(a), window.gantt.parse({ data: [{ id: 1, text: "Planning", start_date: "2019-08-01 00:00", duration: 3, progress: 1, task_class: "planning" }, { id: 2, text: "Research", start_date: "2019-08-02 00:00", duration: 5, progress: .5, task_class: "research" }, { id: 3, text: "Design", start_date: "2019-08-02 00:00", duration: 10, progress: .4, task_class: "design" }, { id: 4, text: "Review", start_date: "2019-08-05 00:00", duration: 5, progress: .8, task_class: "review" }, { id: 5, text: "Develop", start_date: "2019-08-06 00:00", duration: 10, progress: .3, open: !0, task_class: "develop" }, { id: 6, text: "Review II", start_date: "2019-08-10 00:00", duration: 4, progress: .02, task_class: "review-2" }], links: [{ id: 1, source: 1, target: 2, type: "0" }, { id: 2, source: 1, target: 3, type: "0" }, { id: 3, source: 3, target: 4, type: "0" }, { id: 4, source: 6, target: 5, type: "3" }] });
            const n = t.querySelectorAll("input[name=scaleView]"),
                o = t.querySelector("[data-gantt-progress]"),
                r = t.querySelector("[data-gantt-links]");
            n.forEach((t => { t.addEventListener("click", (t => { window.gantt.ext.zoom.setLevel(t.target.value); })); })), r.addEventListener("change", (t => { window.gantt.config.show_links = t.target.checked, window.gantt.init(a); })), o.addEventListener("change", (t => { window.gantt.config.show_progress = t.target.checked, window.gantt.init(a); }));
        }
    };
    ...
    var pad = function(r, n) { return void 0 === n && (n = 2), ("000" + r).slice(-1 * n) };
    var int = function(r) { return !0 === r ? 1 : 0 };
    ...
    function debounce(r, n) {
        ...
        return function() {
            var e = this,
                o = arguments;
            clearTimeout(t), t = setTimeout((function() { return r.apply(e, o) }), n);
        }
    }
    var arrayify = function(r) { return r instanceof Array ? r : [r] };
    ...
    function createElement(e, t, n) { var r = window.document.createElement(e); return t = t || "", n = n || "", r.className = t, void 0 !== n && (r.textContent = n), r }

    function clearNode(e) { for (; e.firstChild;) e.removeChild(e.firstChild); }

    function findParent(e, t) { return t(e) ? e : e.parentNode ? findParent(e.parentNode, t) : void 0 }
    ...
    function getEventTarget(e) { try { return "function" == typeof e.composedPath ? e.composedPath()[0] : e.target } catch (t) { return e.target } }

    var doNothing = function() {};
    var monthToStr = function(t, n, e) { return e.months[n ? "shorthand" : "longhand"][t] };
    var revFormat = {
        D: doNothing,
        F: function(t, n, e) { t.setMonth(e.months.longhand.indexOf(n)); },
        G: function(t, n) { t.setHours((t.getHours() >= 12 ? 12 : 0) + parseFloat(n)); },
        H: function(t, n) { t.setHours(parseFloat(n)); },
        J: function(t, n) { t.setDate(parseFloat(n)); },
        K: function(t, n, e) { t.setHours(t.getHours() % 12 + 12 * int(new RegExp(e.amPM[1], "i").test(n))); },
        M: function(t, n, e) { t.setMonth(e.months.shorthand.indexOf(n)); },
        S: function(t, n) { t.setSeconds(parseFloat(n)); },
        U: function(t, n) { return new Date(1e3 * parseFloat(n)) },
        W: function(t, n, e) {
            var o = parseInt(n),
                r = new Date(t.getFullYear(), 0, 2 + 7 * (o - 1), 0, 0, 0, 0);
            return r.setDate(r.getDate() - r.getDay() + e.firstDayOfWeek), r
        },
        Y: function(t, n) { t.setFullYear(parseFloat(n)); },
        Z: function(t, n) { return new Date(n) },
        d: function(t, n) { t.setDate(parseFloat(n)); },
        h: function(t, n) { t.setHours((t.getHours() >= 12 ? 12 : 0) + parseFloat(n)); },
        i: function(t, n) { t.setMinutes(parseFloat(n)); },
        j: function(t, n) { t.setDate(parseFloat(n)); },
        l: doNothing,
        m: function(t, n) { t.setMonth(parseFloat(n) - 1); },
        n: function(t, n) { t.setMonth(parseFloat(n) - 1); },
        s: function(t, n) { t.setSeconds(parseFloat(n)); },
        u: function(t, n) { return new Date(parseFloat(n)) },
        w: doNothing,
        y: function(t, n) { t.setFullYear(2e3 + parseFloat(n)); }
    };
    var tokenRegex = { D: "", F: "", G: "(\\d\\d|\\d)", H: "(\\d\\d|\\d)", J: "(\\d\\d|\\d)\\w+", K: "", M: "", S: "(\\d\\d|\\d)", U: "(.+)", W: "(\\d\\d|\\d)", Y: "(\\d{4})", Z: "(.+)", d: "(\\d\\d|\\d)", h: "(\\d\\d|\\d)", i: "(\\d\\d|\\d)", j: "(\\d\\d|\\d)", l: "", m: "(\\d\\d|\\d)", n: "(\\d\\d|\\d)", s: "(\\d\\d|\\d)", u: "(.+)", w: "(\\d\\d|\\d)", y: "(\\d{2})" };
    var formats = { Z: function(t) { return t.toISOString() }, D: function(t, n, e) { return n.weekdays.shorthand[formats.w(t, n, e)] }, F: function(t, n, e) { return monthToStr(formats.n(t, n, e) - 1, !1, n) }, G: function(t, n, e) { return pad(formats.h(t, n, e)) }, H: function(t) { return pad(t.getHours()) }, J: function(t, n) { return void 0 !== n.ordinal ? t.getDate() + n.ordinal(t.getDate()) : t.getDate() }, K: function(t, n) { return n.amPM[int(t.getHours() > 11)] }, M: function(t, n) { return monthToStr(t.getMonth(), !0, n) }, S: function(t) { return pad(t.getSeconds()) }, U: function(t) { return t.getTime() / 1e3 }, W: function(t, n, e) { return e.getWeek(t) }, Y: function(t) { return pad(t.getFullYear(), 4) }, d: function(t) { return pad(t.getDate()) }, h: function(t) { return t.getHours() % 12 ? t.getHours() % 12 : 12 }, i: function(t) { return pad(t.getMinutes()) }, j: function(t) { return t.getDate() }, l: function(t, n) { return n.weekdays.longhand[t.getDay()] }, m: function(t) { return pad(t.getMonth() + 1) }, n: function(t) { return t.getMonth() + 1 }, s: function(t) { return t.getSeconds() }, u: function(t) { return t.getTime() }, w: function(t) { return t.getDay() }, y: function(t) { return String(t.getFullYear()).substring(2) } };
    ...
    var createDateFormatter = function(e) {
        var t = e.config,
            ...
            o = e.isMobile,
            i = void 0 !== o && o;
        return function(e, t, n) { var o = n || a; return void 0 === r.formatDate || i ? t.split("").map((function(t, n, a) { return formats[t] && "\\" !== a[n - 1] ? formats[t](e, o, r) : "\\" !== t ? t : "" })).join("") : r.formatDate(e, t, o) }
    };
    ...
    function compareDates(e, t, r) { return void 0 === r && (r = !0), !1 !== r ? new Date(e.getTime()).setHours(0, 0, 0, 0) - new Date(t.getTime()).setHours(0, 0, 0, 0) : e.getTime() - t.getTime() }
    var isBetween = function(e, t, r) { return e > Math.min(t, r) && e < Math.max(t, r) };
    var calculateSecondsSinceMidnight = function(e, t, r) { return 3600 * e + 60 * t + r };
    ...
    "function" != typeof Object.assign && (Object.assign = function(n) {
        ...
        for (var e = function(t) { t && Object.keys(t).forEach((function(r) { return n[r] = t[r] })); }, o = 0, c = t; o < c.length; o++) {
            var f = c[o];
            e(f);
        }
        return n
    ...
    function FlatpickrInstance(e, t) {
        ...
        function a() { var e; return (null === (e = n.calendarContainer) || void 0 === e ? void 0 : e.getRootNode()).activeElement || document.activeElement }

        function i(e) { return e.bind(n) }
        ...
        function s(e, t, a) { void 0 !== n.latestSelectedDateObj && n.latestSelectedDateObj.setHours(e % 24, t, a || 0, 0), n.hourElement && n.minuteElement && !n.isMobile && (n.hourElement.value = pad(n.config.time_24hr ? e : (12 + e) % 12 + 12 * int(e % 12 == 0)), n.minuteElement.value = pad(t), void 0 !== n.amPM && (n.amPM.textContent = n.l10n.amPM[int(e >= 12)]), void 0 !== n.secondElement && (n.secondElement.value = pad(a))); }
        ...
        function f(e, t, a, i) { return t instanceof Array ? t.forEach((function(t) { return f(e, t, a, i) })) : e instanceof Array ? e.forEach((function(e) { return f(e, t, a, i) })) : (e.addEventListener(t, a, i), void n._handlers.push({ remove: function() { return e.removeEventListener(t, a, i) } })) }

        function u() { Q("onChange"); }
        ...
        function m(e, t) {
            var a = void 0 !== e ? n.parseDate(e) : n.latestSelectedDateObj || (n.config.minDate && n.config.minDate > n.now ? n.config.minDate : n.config.maxDate && n.config.maxDate < n.now ? n.config.maxDate : n.now),
                i = n.currentYear,
                o = n.currentMonth;
            try { void 0 !== a && (n.currentYear = a.getFullYear(), n.currentMonth = a.getMonth()); } catch (e) { e.message = "Invalid date supplied: " + a, n.config.errorHandler(e); }
            t && n.currentYear !== i && (Q("onYearChange"), y()), !t || n.currentYear === i && n.currentMonth === o || Q("onMonthChange"), n.redraw();
        }

        function g(e) { var t = getEventTarget(e);~t.className.indexOf("arrow") && p(e, t.classList.contains("arrowUp") ? 1 : -1); }
        ...
        function T(e) { return n.calendarContainer.contains(e) }
        ...
        function I(e) {
            if (n.isOpen && !n.config.inline) {
                var t = getEventTarget(e),
                    ...
                    o = !n.config.ignoredFocusElements.some((function(e) { return e.contains(t) }));
        ...
        function S(e, t) {
            ...
            for (var o = !!n.config.enable, r = null !== (a = n.config.enable) && void 0 !== a ? a : n.config.disable, l = 0, c = void 0; l < r.length; l++) { if ("function" == typeof(c = r[l]) && c(i)) return o; if (c instanceof Date && void 0 !== i && c.getTime() === i.getTime()) return o; if ("string" == typeof c) { var s = n.parseDate(c, void 0, !0); return s && s.getTime() === i.getTime() ? o : !o } if ("object" == typeof c && void 0 !== i && c.from && c.to && i.getTime() >= c.from.getTime() && i.getTime() <= c.to.getTime()) return o }
            return !o
        }

        function N(e) { return void 0 !== n.daysContainer && (-1 === e.className.indexOf("hidden") && -1 === e.className.indexOf("flatpickr-disabled") && n.daysContainer.contains(e)) }
        ...
        function P(t) {
            ...
            if (13 === t.keyCode && o) {
                ...
                switch (t.keyCode) {
                    ...
                    case 9:
                        if (f) {
                            var p = [n.hourElement, n.minuteElement, n.secondElement, n.amPM].concat(n.pluginElements).filter((function(e) { return e })),
                                h = p.indexOf(i);
                            if (-1 !== h) {
            ...
            if (void 0 === t && (t = "flatpickr-day"), 1 === n.selectedDates.length && (!e || e.classList.contains(t) && !e.classList.contains("flatpickr-disabled"))) {
                ...
                Array.from(n.rContainer.querySelectorAll("*:nth-child(-n+" + n.config.showMonths + ") > ." + t)).forEach((function(t) {
                    var o = t.dateObj.getTime(),
                        r = c > 0 && o < c || s > 0 && o > s;
                    if (r) return t.classList.add("notAllowed"), void["inRange", "startRange", "endRange"].forEach((function(e) { t.classList.remove(e); }));
                    l && !r || (["startRange", "inRange", "endRange", "notAllowed"].forEach((function(e) { t.classList.remove(e); })), void 0 !== e && (e.classList.add(a <= n.selectedDates[0].getTime() ? "startRange" : "endRange"), i < a && o === i ? t.classList.add("startRange") : i > a && o === i && t.classList.add("endRange"), o >= c && (0 === s || o <= s) && isBetween(o, i, a) && t.classList.add("inRange")));
                }));
            }
        }

        function F() {!n.isOpen || n.config.static || n.config.inline || R(); }

        function j(e) {
            return function(t) {
                var a = n.config["_" + e + "Date"] = n.parseDate(t, n.config.dateFormat),
                    i = n.config["_" + ("min" === e ? "max" : "min") + "Date"];
                void 0 !== a && (n["min" === e ? "minDateHasTime" : "maxDateHasTime"] = a.getHours() > 0 || a.getMinutes() > 0 || a.getSeconds() > 0), n.selectedDates && (n.selectedDates = n.selectedDates.filter((function(e) { return S(e) })), n.selectedDates.length || "min" !== e || c(a), Z()), n.daysContainer && (B(), void 0 !== a ? n.currentYearElement[e] = a.getFullYear().toString() : n.currentYearElement.removeAttribute(e), n.currentYearElement.disabled = !!i && void 0 !== a && i.getFullYear() === a.getFullYear());
            }
        }

        function H() { return n.config.wrap ? e.querySelector("[data-input]") : e }

        function L() { "object" != typeof n.config.locale && void 0 === flatpickr.l10ns[n.config.locale] && n.config.errorHandler(new Error("flatpickr: invalid locale " + n.config.locale)), n.l10n = __assign(__assign({}, flatpickr.l10ns.default), "object" == typeof n.config.locale ? n.config.locale : "default" !== n.config.locale ? flatpickr.l10ns[n.config.locale] : void 0), tokenRegex.D = "(" + n.l10n.weekdays.shorthand.join("|") + ")", tokenRegex.l = "(" + n.l10n.weekdays.longhand.join("|") + ")", tokenRegex.M = "(" + n.l10n.months.shorthand.join("|") + ")", tokenRegex.F = "(" + n.l10n.months.longhand.join("|") + ")", tokenRegex.K = "(" + n.l10n.amPM[0] + "|" + n.l10n.amPM[1] + "|" + n.l10n.amPM[0].toLowerCase() + "|" + n.l10n.amPM[1].toLowerCase() + ")", void 0 === __assign(__assign({}, t), JSON.parse(JSON.stringify(e.dataset || {}))).time_24hr && void 0 === flatpickr.defaultConfig.time_24hr && (n.config.time_24hr = n.l10n.time_24hr), n.formatDate = createDateFormatter(n), n.parseDate = createDateParser({ config: n.config, l10n: n.l10n }); }
            ...
            if ("function" != typeof n.config.position) {
                if (void 0 !== n.calendarContainer) {
                    ...
                    var t = e || n._positionElement,
                        a = Array.prototype.reduce.call(n.calendarContainer.children, (function(e, t) { return e + t.offsetHeight }), 0),
        ...
        function B() { n.config.noCalendar || n.isMobile || (y(), z(), M()); }

        function W() { n._input.focus(), -1 !== window.navigator.userAgent.indexOf("MSIE") || void 0 !== navigator.msMaxTouchPoints ? setTimeout(n.close, 0) : n.close(); }

        function K(e) {
            e.preventDefault(), e.stopPropagation();
            var t = findParent(getEventTarget(e), (function(e) { return e.classList && e.classList.contains("flatpickr-day") && !e.classList.contains("flatpickr-disabled") && !e.classList.contains("notAllowed") }));
            if (void 0 !== t) {
                var a = t,
                ...
                } else "range" === n.config.mode && (2 === n.selectedDates.length && n.clear(!1, !1), n.latestSelectedDateObj = i, n.selectedDates.push(i), 0 !== compareDates(i, n.selectedDates[0], !0) && n.selectedDates.sort((function(e, t) { return e.getTime() - t.getTime() })));
                if (l(), o) {
        ...
        n.parseDate = createDateParser({ config: n.config, l10n: n.l10n }), n._handlers = [], n.pluginElements = [], n.loadedPlugins = [], n._bind = f, n._setHoursFromDate = c, n._positionCalendar = R, n.changeMonth = x, n.changeYear = O, n.clear = function(e, t) {
            void 0 === e && (e = !0);
            void 0 === t && (t = !0);
            ...
            !0 === n.config.enableTime && !0 === n.config.noCalendar && (!1 !== n.config.allowInput || void 0 !== e && n.timeContainer.contains(e.relatedTarget) || setTimeout((function() { return n.hourElement.select() }), 50));
        }, n.redraw = B, n.set = function(e, t) {
            if (null !== e && "object" == typeof e)
                for (var a in Object.assign(n.config, e), e) void 0 !== q[a] && q[a].forEach((function(e) { return e() }));
            else n.config[e] = t, void 0 !== q[e] ? q[e].forEach((function(e) { return e() })) : HOOKS.indexOf(e) > -1 && (n.config[e] = arrayify(t));
            n.redraw(), Z(!0);
        ...
        var q = { locale: [L, _], showMonths: [E, o, k], minDate: [m], maxDate: [m], positionElement: [$], clickOpens: [function() {!0 === n.config.clickOpens ? (f(n._input, "focus", n.open), f(n._input, "click", n.open)) : (n._input.removeEventListener("focus", n.open), n._input.removeEventListener("click", n.open)); }] };

        function U(e, t) {
            var a = [];
            if (e instanceof Array) a = e.map((function(e) { return n.parseDate(e, t) }));
                ...
                case "multiple":
                    ...
                    break;
                case "range":
                    a = e.split(n.l10n.rangeSeparator).map((function(e) { return n.parseDate(e, t) }));
            } else n.config.errorHandler(new Error("Invalid date supplied: " + JSON.stringify(e)));
            n.selectedDates = n.config.allowInvalidPreload ? a : a.filter((function(e) { return e instanceof Date && S(e, !1) })), "range" === n.config.mode && n.selectedDates.sort((function(e, t) { return e.getTime() - t.getTime() }));
        }

        function J(e) { return e.slice().map((function(e) { return "string" == typeof e || "number" == typeof e || e instanceof Date ? n.parseDate(e, void 0, !0) : e && "object" == typeof e && e.from && e.to ? { from: n.parseDate(e.from, void 0), to: n.parseDate(e.to, void 0) } : e })).filter((function(e) { return e })) }

        function $() { n._positionElement = n.config.positionElement || n._input; }
        ...
        function V(e) { var t = document.createEvent("Event"); return t.initEvent(e, !0, !0), t }

        function X(e) { for (var t = 0; t < n.selectedDates.length; t++) { var a = n.selectedDates[t]; if (a instanceof Date && 0 === compareDates(a, e)) return "" + t } return !1 }
        ...
        function G(e) { var t = e || (n.config.altInput ? n.config.altFormat : n.config.dateFormat); return n.selectedDates.map((function(e) { return n.formatDate(e, t) })).filter((function(e, t, a) { return "range" !== n.config.mode || n.config.enableTime || a.indexOf(e) === t })).join("range" !== n.config.mode ? n.config.conjunction : n.l10n.rangeSeparator) }

        function Z(e) { void 0 === e && (e = !0), void 0 !== n.mobileInput && n.mobileFormatStr && (n.mobileInput.value = void 0 !== n.latestSelectedDateObj ? n.formatDate(n.latestSelectedDateObj, n.mobileFormatStr) : ""), n.input.value = G(n.config.dateFormat), void 0 !== n.altInput && (n.altInput.value = G(n.config.altFormat)), !1 !== e && Q("onValueUpdate"); }
            ...
            n.element = n.input = e, n.isOpen = !1,
                function() {
                    var a = ["wrap", "weekNumbers", "allowInput", "allowInvalidPreload", "clickOpens", "time_24hr", "enableTime", "noCalendar", "altInput", "shorthandCurrentMonth", "inline", "static", "enableSeconds", "disableMobile"],
                        ...
                        r = {};
                    n.config.parseDate = o.parseDate, n.config.formatDate = o.formatDate, Object.defineProperty(n.config, "enable", { get: function() { return n.config._enable }, set: function(e) { n.config._enable = J(e); } }), Object.defineProperty(n.config, "disable", { get: function() { return n.config._disable }, set: function(e) { n.config._disable = J(e); } });
                    var l = "time" === o.mode;
                    ...
                    Object.defineProperty(n.config, "minDate", { get: function() { return n.config._minDate }, set: j("min") }), Object.defineProperty(n.config, "maxDate", { get: function() { return n.config._maxDate }, set: j("max") });
                    var d = function(e) { return function(t) { n.config["min" === e ? "_minTime" : "_maxTime"] = n.parseDate(t, "H:i:S"); } };
                    Object.defineProperty(n.config, "minTime", { get: function() { return n.config._minTime }, set: d("min") }), Object.defineProperty(n.config, "maxTime", { get: function() { return n.config._maxTime }, set: d("max") }), "time" === o.mode && (n.config.noCalendar = !0, n.config.enableTime = !0);
                    Object.assign(n.config, r, o);
                    for (var f = 0; f < a.length; f++) n.config[a[f]] = !0 === n.config[a[f]] || "true" === n.config[a[f]];
                    HOOKS.filter((function(e) { return void 0 !== n.config[e] })).forEach((function(e) { n.config[e] = arrayify(n.config[e] || []).map(i); })), n.isMobile = !n.config.disableMobile && !n.config.inline && "single" === n.config.mode && !n.config.disable.length && !n.config.enable && !n.config.weekNumbers && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
                    for (f = 0; f < n.config.plugins.length; f++) { var u = n.config.plugins[f](n) || {}; for (var m in u) HOOKS.indexOf(m) > -1 ? n.config[m] = arrayify(u[m]).map(i).concat(n.config[m]) : void 0 === o[m] && (n.config[m] = u[m]); }
                ...
                function() {
                    n.config.wrap && ["open", "close", "toggle", "clear"].forEach((function(e) { Array.prototype.forEach.call(n.element.querySelectorAll("[data-" + e + "]"), (function(t) { return f(t, "click", n[e]) })); }));
                    ...
                    function() {
                        ...
                        try { n.input.parentNode && n.input.parentNode.insertBefore(n.mobileInput, n.input.nextSibling); } catch (e) {}
                        f(n.mobileInput, "change", (function(e) { n.setDate(getEventTarget(e).value, !1, n.mobileFormatStr), Q("onChange"), Q("onClose"); }));
                    }();
                    var e = debounce(F, 50);
                    n._debouncedChange = debounce(u, DEBOUNCED_CHANGE_MS), n.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && f(n.daysContainer, "mouseover", (function(e) { "range" === n.config.mode && Y(getEventTarget(e)); }));
                    ...
                    if (void 0 !== n.timeContainer && void 0 !== n.minuteElement && void 0 !== n.hourElement) {
                        var t = function(e) { return getEventTarget(e).select() };
                        f(n.timeContainer, ["increment"], r), f(n.timeContainer, "blur", r, { capture: !0 }), f(n.timeContainer, "click", g), f([n.hourElement, n.minuteElement], ["focus", "click"], t), void 0 !== n.secondElement && f(n.secondElement, "focus", (function() { return n.secondElement && n.secondElement.select() })), void 0 !== n.amPM && f(n.amPM, "click", (function(e) { r(e); }));
                    }
    ...
    "undefined" != typeof HTMLElement && "undefined" != typeof HTMLCollection && "undefined" != typeof NodeList && (HTMLCollection.prototype.flatpickr = NodeList.prototype.flatpickr = function(e) { return _flatpickr(this, e) }, HTMLElement.prototype.flatpickr = function(e) { return _flatpickr([this], e) });
    var flatpickr = function(e, t) { return "string" == typeof e ? _flatpickr(window.document.querySelectorAll(e), t) : e instanceof Node ? _flatpickr([e], t) : _flatpickr(e, t) };
    ...
    const flatpickrInit = () => { document.querySelectorAll(".datetimepicker").forEach((t => { flatpickr(t, getData(t, "options")); })); };

    const detectorInit = () => {
        const { is: a } = window, s = document.querySelector("html");
        a.opera() && addClass(s, "opera"), a.mobile() && addClass(s, "mobile"), a.firefox() && addClass(s, "firefox"), a.safari() && addClass(s, "safari"), a.ios() && addClass(s, "ios"), a.iphone() && addClass(s, "iphone"), a.ipad() && addClass(s, "ipad"), a.ie() && addClass(s, "ie"), a.edge() && addClass(s, "edge"), a.chrome() && addClass(s, "chrome"), a.mac() && addClass(s, "osx"), a.windows() && addClass(s, "windows"), navigator.userAgent.match("CriOS") && addClass(s, "chrome");
    };
