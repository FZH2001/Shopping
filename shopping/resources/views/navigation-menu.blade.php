        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->role==1)
                    <x-jet-nav-link href="{{ route('manage') }}" :active="request()->routeIs('manage')">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-jet-dropdown align="right" width="20" >
                    ...
                    <a role="button" href="{{ route('cart.list') }}" class="btn btn-info m-4" >
                        <i class="fa fa-shopping-cart" aria-hidden="true"></i> {{__('Cart')}} <span
                            class="badge badge-pill badge-danger">{{ Cart::instance(Auth::user()->id)->count() }}</span>
                    </a>
