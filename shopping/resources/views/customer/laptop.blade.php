                    ...
                    <div class="col-12">
                        <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 bag-bg"
                                style="background-image:url('	https://cdn.pixabay.com/photo/2016/03/26/13/09/cup-of-coffee-1280537__480.jpg');"></div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="gift-items-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 banner-bg"
                                style="background-image:url('	https://cdn.pixabay.com/photo/2016/11/20/09/06/laptop-1842297__480.jpg');">
                            </div>
                            <!--/.bg-holder-->
