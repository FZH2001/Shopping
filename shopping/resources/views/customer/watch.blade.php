                    ...
                    <div class="col-12">
                        <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 bag-bg"
                                style="background-image:url('	https://cdn.pixabay.com/photo/2020/05/11/15/52/canon-5158884__480.jpg');"></div>
                            <!--/.bg-holder-->
                            <div class="bg-holder z-index--1 shape-bg"
                                style="background-image:url('{{ asset('img/e-commerce/whooping_banner_shape.png')}}') }}')');">
                            </div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="gift-items-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 banner-bg"
                                style="background-image:url('	https://cdn.pixabay.com/photo/2020/04/11/02/27/airpods-per-5028520__480.jpg');">
                            </div>
                            <!--/.bg-holder-->
