                ...
                <div class="row g-3 mb-9">
                    <div class="col-12">
                        <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 bag-bg"
                                style="background-image:url('https://cdn.pixabay.com/photo/2016/03/27/20/00/coffee-1284041__480.jpg');"></div>
                            <!--/.bg-holder-->
                            <div class="bg-holder z-index--1 shape-bg"
                                style="background-image:url('	https://www.apple.com/v/home/ap/images/promos/ipad…r/promo_ipadair_avail__ferd4bfpcdm6_medium_2x.jpg');">
                            </div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="gift-items-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 banner-bg"
                                style="background-image:url('https://www.apple.com/v/home/ap/images/promos/ipad-air/promo_ipadair_avail__ferd4bfpcdm6_medium_2x.jpg');">
                            </div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div
                            ...
                            <div class="bg-holder z-index--1 banner-bg"
                                style="background-image:url('	https://prium.github.io/phoenix/v1.2.0/assets/img/e-commerce/best-in-market-bg.png');"></div>
                            <!--/.bg-holder-->
                            <div class="row align-items-center w-100">
                                ...
                                <div class="col-4"><img class="w-75" src="	https://prium.github.io/phoenix/v1.2.0/assets/img/e-commerce/5.png
                                  "
                                        alt=""></div>
                            </div>
                        </div>
