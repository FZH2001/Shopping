            ...
            <div class="col-12 col-xxl-6">
                ...
                <div class="row align-items-center g-4">
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><img src="{{asset('img/icons/illustrations/4.png')}}" alt="" height="46" width="46" />
                            <div class="ms-3">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><img src="{{asset('img/icons/illustrations/2.png')}}" alt="" height="46" width="46" />
                            <div class="ms-3">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><img src="{{asset('img/icons/illustrations/3.png')}}" alt="" height="46" width="46" />
                            <div class="ms-3">
        ...
        <div data-list='{"valueNames":["product","customer","rating","review","time"],"page":6}'>
                    ...
                    <div class="row g-2">
                        <div class="col-auto flex-1">
                            <div class="search-box">
                                <form class="position-relative" data-bs-toggle="search" data-bs-display="static"><input class="form-control form-control search-input search" type="search" placeholder="Search" aria-label="Search" />
                                    <span class="fas fa-search search-box-icon"></span>
                                </form>
                            </div>
                        </div>
                        <div class="col-auto"><button class="btn btn-sm btn-phoenix-secondary bg-white hover-bg-100" type="button">All products</button><button class="btn btn-sm btn-phoenix-secondary ms-2 bg-white hover-bg-100" type="button" data-bs-toggle="dropdown"
                                data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--2"></span></button>
                ...
                <table class="table fs--1 mb-0 border-top border-200">
                    ...
                    <tbody class="list" id="table-latest-review-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/1.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle text-start ps-5 status"><span class="badge fs--1 badge-light-success">Approved<span class="ms-2 fas fa-check"></span></span>
                            </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/2.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/59.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/3.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/58.png')}}" alt="" /></div>
                            ...
                            <td class="align-middle text-start ps-5 status"><span class="badge fs--1 badge-light-warning">Pending<span class="ms-2 fas fa-stopwatch"></span></span>
                            </td>
                            <td class="align-middle text-end time white-space-nowrap">
                                <div class="hover-hide">
                                    <h6 class="text-1000 mb-0">Just now</h6>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/4.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/avatar-placeholder.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/5.png')}}" alt="" width="53" /></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/6.png')}}" alt="" width="53" /></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/7.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/3.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/8.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/26.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/9.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/29.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/10.png')}}" alt="" width="53" /></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/11.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/8.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/12.png')}}" alt="" width="53" /></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/13.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/9.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/14.png')}}" alt="" width="53" /></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('img//products/15.png')}}" alt="" width="53" /></td>
                            ...
                            <td class="align-middle customer white-space-nowrap">
                                <a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('img/team/24.png')}}" alt="" /></div>
            ...
            <div class="row align-items-center py-1">
                ...
                <div class="col d-flex fs--1">
                    <p class="mb-0 d-none d-sm-block me-3 fw-semi-bold text-900" data-list-info="data-list-info"></p><a class="fw-semi-bold" href="#!" data-list-view="*">{{__('View all')}}<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a><a class="fw-semi-bold d-none" href="#!" data-list-view="less">View Less</a>
                </div>
                <div class="col-auto d-flex">
                    <button class="btn btn-link px-1 me-1" type="button" title="Previous" data-list-pagination="prev"><span class="fas fa-chevron-left me-2"></span>Previous</button><button class="btn btn-link px-1 ms-1" type="button" title="Next"
    ...
    <div class="row gx-6">
        <div class="col-12 col-xl-6">
                        ...
                        <tr>
                            <td class="white-space-nowrap ps-0" style="width:32%">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#!">
                                        <div class="d-flex align-items-center"><img src="{{asset('img/country/india.png')}}" alt="" width="24" />
                        ...
                        <tr>
                            <td class="white-space-nowrap ps-0" style="width:32%">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#!">
                                        <div class="d-flex align-items-center"><img src="{{asset('img/country/china.png')}}" alt="" width="24" />
                        ...
                        <tr>
                            <td class="white-space-nowrap ps-0" style="width:32%">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#!">
                                        <div class="d-flex align-items-center"><img src="{{asset('img/country/usa.png')}}" alt="" width="24" />
                        ...
                        <tr>
                            <td class="white-space-nowrap ps-0" style="width:32%">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#!">
                                        <div class="d-flex align-items-center"><img src="{{asset('img/country/south-korea.png')}}" alt="" width="24" />
                        ...
                        <tr>
                            <td class="white-space-nowrap ps-0" style="width:32%">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#!">
                                        <div class="d-flex align-items-center"><img src="{{asset('img/country/vietnam.png')}}" alt="" width="24" />
            ...
            <div class="d-flex align-items-center justify-content-between py-2 fs--1 mb-1">
                <p class="mb-0 d-none d-sm-block me-3 fw-semi-bold text-900" data-list-info="">1 to 5 <span class="text-600"> Items of </span> 15</p><a class="fw-semi-bold" href="#!" data-list-view="*">{{__('View all')}}<span class="fas fa-angle-right ms-2" data-fa-transform="down-1"></span></a>
            </div>
        </div>
